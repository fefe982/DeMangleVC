...
namespace DeMangleVC
{
    ...
    class DeMangel
    {
        ...
        private String GetTemplateArgumentList()
        {
            ...
            //int iTmp;
            strTplParaType = GetTypeLikeID(true).getDeclaration("");// GetTplPara();
        ...
        private Type GetTypeLikeID(bool Push)
        {
            ...
            case '$': // special type or type like identifier
                ...
                case '$': // Simple ref, will use the letter C,
                    iProcessPos++;
                    retType = GetSimpleRef(false);//GetType(false, out iInsPosGet);
                    break;
                default:
                    throw new Exception();
                }
        ...
        private TypeSimpleRef GetSimpleRef(bool bPush)
        {
            String CVQ = "";
            TypeSimpleRef sType = new TypeSimpleRef();
